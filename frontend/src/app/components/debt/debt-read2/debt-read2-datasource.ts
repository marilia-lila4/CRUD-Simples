...
/**
 * Data source for the DebtRead2 view. This class should
 * encapsulate all logic for fetching and manipulating the displayed data
 * (including sorting, pagination, and filtering).
 */
export class DebtRead2DataSource extends DataSource<Debt> {
  data: Debt[] = EXAMPLE_DATA;
   ...
   */
  private getPagedData(data: Debt[]): Debt[] {
    if (this.paginator) {
   ...
   * this would be replaced by requesting the appropriate data from the server.
   */
  private getSortedData(data: Debt[]): Debt[] {
